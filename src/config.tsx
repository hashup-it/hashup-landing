...
export const langsOfWhitepaper: string[] = [
  Languages.en.code,
  Languages.pl.code,
];
...
export const Documents = {
  termsAndConditions:
    "https://cdn.hashup.it/landing/HashUp.IT_-_Terms_And_Contitions.pdf",
  // airdropTermsOfUse: "https://cdn.hashup.it/landing/Hash_Token_Airdrop_Terms_and_Conditions.pdf",
  privacyPolicy:
    "https://cdn.hashup.it/landing/HashUp.IT_-_Data_Protection_Policy.pdf",
