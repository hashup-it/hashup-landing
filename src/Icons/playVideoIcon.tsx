...
export const PlayVideoIcon: FC<IPlayVideoIcon> = ({ width, height, cursor }) => {
	return (
		<Icon width={width} height={height} viewBox="0 0 31 31" fill="none" xmlns="http://www.w3.org/2000/svg" cursor={cursor}>
