...
export const MediumIcon = () => {
	return (
		<Icon width="16px" height="16px" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
			<g clip-path="url(#clip0_2679_3284)">
				<path
				...
				/>
				<path
					d="M13.9752 7.88502C13.9752 10.2512 12.965 12.1702 11.7189 12.1702C10.4728 12.1702 9.46265 10.2512 9.46265 7.88502C9.46265 5.51881 10.4727 3.59985 11.7188 3.59985C12.9649 3.59985 13.9751 5.5182 13.9751 7.88502"
					fill="white"
				/>
				<path
