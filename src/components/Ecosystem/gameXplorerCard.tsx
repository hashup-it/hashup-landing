  ...
  return (
    <Flex w="100vw" h="80vh" p="50px 140px">
      <Flex flexDirection="column" gridGap="50px" maxW="40%">
        ...
        The future of social media. Create a stunning, customizable profile and take pride in your games collection. 
        Know your friends’ items and get inspired by following influencers!  
        </Text>
        <Flex gridGap="3px">
          <Flex
