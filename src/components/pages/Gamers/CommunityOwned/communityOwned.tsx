	...
	const typeOptions: { [p: number]: () => React.ReactNode } = {
		...
		[ActiveText.SECOND]: () => (
			<Flex direction="column" alignItems="center" textAlign='center'>
				...
				<SlideFade in={enterCount > 0} offsetY="40px">
					<Flex direction="column" maxW={["80%", "80%", "none", "none"]} ml={["15%", "15%", "0%", "0%"]}  >
						<Flex direction="column" mt="100px" textAlign="start">
							<Text fontSize={["20px", "20px", "60px", "60px"]} maxW={["100%", "100%", "70%", "70%"]} lineHeight="110%">
								Well,
							</Text>
						...
						<Flex direction="column" pt={["14px", "14px", "none", "none"]} gridGap={["12px", "12px", "0px", "0px"]} ref={changeItem}>
							<Flex alignItems="center" justifyContent="space-between" maxH='40vh' direction={['column', 'column', 'row', 'row']}>
							...
							<Flex alignItems="center" justifyContent="space-between" maxH='40vh' direction={['column', 'column', 'row', 'row']}>
								<ComponentAnimatedThird
									text="Can you invest in your games?"
									isActive={isActiveComponent}
								/>
								{isActiveComponent === 2 ? (
									<SlideFade in={enterCount > 0} offsetY="60px">
										<Flex direction="column" fontSize={["30px", "30px", "90px", "90px"]} gridGap="-40px" lineHeight="90%">
											Also
											<Text>
												<strong>no</strong>.
											</Text>
